...
This folder contains my work for the Prep Challenge of the DataKit Fall 2025 program.
The goal of this challenge is to translate farmer questions written in **Swahili**, **Luganda**, and **Runyankore/Rukiga** into clear English, and to create simple keyword and glossary outputs from the translations.
...
* `question_sent` was not included in the file, but translation was still possible.
* Around **25 percent** of questions had missing topic labels (not required for this challenge but important to note).
...
This helps reveal how farmers describe pests, crops, weather patterns, and other agricultural concerns.
...
* `Prep_Challenge.ipynb - Colab.pdf`
  Full notebook showing translation workflow
...
If you want, I can also generate a **shorter version**, a **more formal version**, or a version formatted exactly like one of the submissions already in the repo.
